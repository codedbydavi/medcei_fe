  ...
  return (
    <div className="h-screen bg-[#F0F8F8] relative overflow-hidden flex">
      ...
      <div className="relative z-10 w-full flex flex-col md:flex-row items-center justify-center md:justify-between px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-0 gap-4 md:gap-12 max-w-6xl mx-auto">
        ...
        <div className="hidden md:flex flex-col space-y-6 items-center justify-center w-1/2 h-screen sticky top-0 px-10 text-center">
          <h3 className="text-3xl font-bold text-slate-800 mb-2 leading-tight">
            Soluções completas para <br />
            <span className="text-teal-600">o seu bem-estar.</span>
          </h3>

          <div className="flex flex-col gap-4 w-full max-w-md">
            <FeaturePill
              icon={CuidadoIcon}
              text="Cuidados de saúde e fisioterapia"
            />
            <FeaturePill
              icon={TransporteIcon}
              text="Entrega de refeições e medicação"
            />
          ...
          <div className="pt-4">
            <a
              href="https://medcei.com"
              target="_blank"
              rel="noopener noreferrer"
              className="text-teal-600 font-medium hover:text-teal-700 transition-colors underline"
            >
              Saiba mais sobre a nossa missão e serviços!
            </a>
          </div>
        </div>
      </div>
